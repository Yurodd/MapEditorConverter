...
var RainOnMe = `variables
{
    ...
    player:
        ...
        6: active_wall
        7: closestwall
        8: intersection_length
        9: thickness
        10: intersection_length_0
        11: intersection_length_1
        12: thickness_0
        13: intersection_length_2
        14: downwardslope
        15: velocitySlope
}
...
rule("Effect Creation")
{
    ...
    actions
    {
        ...
        Skip(4);
        			...
        			End;
        		Else If(Or(Or(Compare(Value In Array(Global Variable(Wall_ID), Global Variable(x)), ==, 2), Compare(Value In Array(Global Variable(Wall_ID), Global Variable(x)), ==, 4)), Compare(Value In Array(Global Variable(Wall_ID), Global Variable(x)), ==, 6)));
